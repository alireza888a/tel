...
export const LiveSimulatorPreview: React.FC<LiveSimulatorPreviewProps> = ({
  ...
  return (
    <div className="relative flex flex-col items-center pt-8">
        <div className="absolute top-0 flex items-center gap-2 bg-green-500/10 text-green-600 px-4 py-1.5 rounded-full text-sm font-medium border border-green-500/20 shadow-sm animate-pulse cursor-pointer hover:bg-green-500/20 transition-colors">
          <Eye size={16} />
          پیش‌نمایش تعاملی (کلیک کنید)
       </div>

      <div className="telegram-simulator mt-8 w-[min(300px,90vw)] shrink-0 bg-[#1c2431] rounded-[30px] border-[6px] border-[#252f3f] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] overflow-hidden relative h-[600px] flex flex-col mx-auto">
             {/* MESSAGE BUBBLE */}
