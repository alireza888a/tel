        ...
        <label
          ...
          className={`flex items-center gap-3 p-3.5 rounded-xl border cursor-pointer transition-all ${
            miniappModules.includes('shop')
              ?'bg-blue-600/15 border-blue-500/50 text-blue-800'
              :'bg-black/[0.03] border-black/10 text-brand-navy/50 hover:text-brand-navy/80'
          }`}
        >
          <input
            type="checkbox"
            ...
            onChange={() => {}}
            className="w-4 h-4 rounded text-blue-600 border-black/20 bg-white focus:ring-0"
          />
