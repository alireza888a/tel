            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/50 border border-slate-300 rounded-xl p-4 pl-12 text-slate-800 focus:outline-none focus:border-purple-500 transition-all font-mono text-left dir-ltr shadow-inner"
                  dir="ltr"
                />
             ...
             <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-slate-200">
                <div className="flex items-center gap-5">
                   ...
                   <div>
                      ...
                      <p className="text-slate-500 font-mono text-sm mt-1">@{botInfo.username}</p>
                   </div>
                </div>
                 ...
                 <div className="flex justify-between items-center mb-4">
                     ...
                     <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 text-xs cursor-pointer select-none">
                            ...
                            />
                            <span className="text-slate-500">پاسخگویی خودکار فعال</span>
                        </label>
